...
export default function CreateNE() {
    ...
    const handleFormSubmit = e => {
        ...
        if (validate()) {
            ...
            formData.append('neid', values.neid)
    ...
    return (
        <>
            <div className="container text-center">
                <p className="lead" style={{paddingTop:"20px", fontSize:"30px"}}>Create NE</p>
            </div>
                ...
                <div className="card" style={{margin:"20px 100px 100px"}}>
                    ...
                    <div className="card-body">
                        ...
                        <div className="form-group text-center float-start" style={{paddingLeft:"20px"}}>
                            <Link to="/newslist" className="btn btn-light">Cancel</Link>
                        </div>
                    </div>
                </div>
            </form>
