...
export default function CreateCN() {
    ...
    const handleFormSubmit = e => {
        ...
        if (validate()) {
            ...
            formData.append('cnid', values.cnid)
    ...
    return (
        <>
            <div className="container text-center">
                <p className="lead" style={{paddingTop:"20px", fontSize:"30px"}}>Create Contact Banner</p>
            </div>
